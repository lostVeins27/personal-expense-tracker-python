...
def expense_window():
    ...
    def attach_file():
        ...
        def open_image():
            ...
            image_window.title("Reciept Image")
            image_window.geometry(f"{width}x{height}")
            image_window.resizable(False, False)

            img = ctk.CTkImage(light_image = image, dark_image= image, size=(width, height))
        ...
        view_image_button.grid(row = 6 , column = 1, padx = (10, 2), pady = (0, 10), sticky = "ew")

        reciept_image.configure(text="Repick Image")
        reciept_image.grid(row = 6, column = 2, columnspan = 1, padx = 2, pady = (0, 10), sticky = "ew")

        remove_image_button = ctk.CTkButton(window, text="Remove Image")
        remove_image_button.grid(row = 6, column = 3, padx = (2, 10), pady = (0, 10), sticky = "ew")
    ...
    amount_entry.grid(row = 0, column = 1, padx = 10, columnspan = 3,  pady = (10, 5), sticky = "ew")
    ...
    category_cb.grid(row = 1, column = 1, padx = 10, pady = (0,5), columnspan = 3, sticky = "ew")
    ...
    account_cb.grid(row = 2, column = 1, padx = 10, pady = (0,5), columnspan = 3, sticky = "ew")
    ...
    reciept_image.grid(row = 6, column = 1, padx = 10, pady = (0, 10), columnspan = 3, sticky = "ew")

    button_frame = ctk.CTkFrame(window, fg_color="transparent")
    button_frame.grid(row =  7, column = 0, columnspan = 4, padx = 10, pady = (0, 10), sticky = "ew")
